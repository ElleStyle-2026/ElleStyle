...
const adminVideoHighlightRoutes = require('../adminVideoHighlightRoutes');
const adminFeatureHighlightRoutes = require('../adminFeatureHighlightRoutes');
const adminAboutFeatureHighlightRoutes = require('../adminAboutFeatureHighlightRoutes');
const landingBannerRoutes = require('../landingBannerRoutes');
const videoHighlightRoutes = require('../videoHighlightRoutes');
const featureHighlightRoutes = require('../featureHighlightRoutes');
const aboutFeatureHighlightRoutes = require('../aboutFeatureHighlightRoutes');
...
router.use('/video-highlights', videoHighlightRoutes);
router.use('/feature-highlights', featureHighlightRoutes);
router.use('/about-feature-highlights', aboutFeatureHighlightRoutes);
...
router.use('/admin/video-highlights', adminVideoHighlightRoutes);
const adminTestimonialShowcaseRoutes = require('../adminTestimonialShowcaseRoutes');

router.use('/admin/feature-highlights', adminFeatureHighlightRoutes);
router.use('/admin/about-feature-highlights', adminAboutFeatureHighlightRoutes);
router.use('/admin/testimonial-showcase', adminTestimonialShowcaseRoutes); // Admin routes

// We also need to map the public showcase route
const testimonialShowcaseRoutes = require('../testimonialShowcaseRoutes');
router.use('/testimonial-showcase', testimonialShowcaseRoutes);
