        ...
        {priceChangeWarning && (
          <div className="bg-orange-50 border border-orange-200 p-5 rounded-2xl">
            ...
            <div className="flex justify-between items-center bg-white p-3 rounded-xl mb-4 border border-orange-100">
              <span className="text-gray-500 line-through">Old Total: ₹{priceChangeWarning.oldAmount}</span>
              <span className="text-lg font-bold text-black">New Total: ₹{priceChangeWarning.newAmount}</span>
            </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="space-y-4">
                {order.refunds.map((refund, i) => (
                  <div key={i} className="text-sm border-l-2 border-gray-200 pl-3">
                    <p className="font-medium text-gray-900">₹{refund.amount} - {refund.status.toUpperCase()}</p>
