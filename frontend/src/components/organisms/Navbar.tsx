...
import { publicSubCategoryService } from '../../services/publicSubCategoryService';
    ...
    const loadCategories = async () => {
      try {
        const [categories, subcategories] = await Promise.all([
          fetchPublicCategories({ navbar: true }),
          publicSubCategoryService.getSubCategories({ navbar: true })
        ]);
