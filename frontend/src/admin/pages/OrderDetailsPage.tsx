            ...
            <table className="w-full text-left text-sm text-gray-500">
              ...
              <tbody className="divide-y divide-gray-200">
                {order.items?.map((item, idx) => (
                  <tr key={idx} className="bg-white">
                    ...
                    <td className="px-6 py-4 text-right">₹{(item.price * item.quantity)}</td>
                  </tr>
                ))}
              </tbody>
              <tfoot className="bg-gray-50 text-gray-900 font-medium">
                <tr>
                  ...
                  <td className="px-6 py-3 text-right">₹{order.subtotal || '0.00'}</td>
                </tr>
                <tr>
                  <td colSpan={3} className="px-6 py-3 text-right">Shipping</td>
                  <td className="px-6 py-3 text-right">₹{order.shippingCharge || '0.00'}</td>
                </tr>
